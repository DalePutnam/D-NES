...
void OpenGLBackend::SwapFrameBuffers()
{
...
void OpenGLBackend::DrawMessages()
{
    std::unique_lock<std::mutex> lock(_messageMutex);
...
void OpenGLBackend::DrawText(const std::string & text, uint32_t xPos, uint32_t yPos)
{
...
void OpenGLBackend::UpdateSurfaceSize()
{
